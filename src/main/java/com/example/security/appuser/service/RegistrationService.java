...
import com.example.security.appuser.modules.AppUserRole;
import com.example.security.appuser.modules.EmailValidator;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request){
        ...
        String token = appService.singUpUser(new AppUser(
